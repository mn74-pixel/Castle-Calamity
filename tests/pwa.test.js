...
(async () => {
  ...
  check(stores.has("castle-calamity-v7.5.0") && stores.get("castle-calamity-v7.5.0").size === 14, "app shell v7.5.0 zapisuje komplet 14 zasobów");
  ...
  console.log("PWA V7.5.0 COMPLETE");
