...
(async () => {
  ...
  check(stores.has("castle-calamity-v7.2.1") && stores.get("castle-calamity-v7.2.1").size === 11, "app shell v7.2.1 zapisuje komplet 11 zasobów");
  ...
  console.log("PWA V7.2.1 COMPLETE");
