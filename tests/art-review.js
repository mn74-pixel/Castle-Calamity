...
vm.runInNewContext(fs.readFileSync(path.join(root,'content/future-eras-v73.js'),'utf8'),{window});
...
fs.mkdirSync(path.join(__dirname,'renders'),{recursive:true});fs.writeFileSync(path.join(__dirname,'renders/art-v73.png'),canvas.toBuffer('image/png'));
